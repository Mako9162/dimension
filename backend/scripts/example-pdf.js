...
import { renderQuotePdf, renderReceiptPdf } from '../src/pdf.js';
...
const receiptFile = new URL('Recibo-Taller-Dimension-ejemplo.pdf', folder);
await writeFile(receiptFile, await renderReceiptPdf({
  number: 1, date: quote.date, amount: 100000, paymentMethod: 'TRANSFERENCIA',
  notes: 'Abono de ejemplo para iniciar los trabajos.', totalPaidSoFar: 100000, quote,
}));
console.log(fileURLToPath(receiptFile));
