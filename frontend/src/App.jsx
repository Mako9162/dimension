...
function Admin() {
  ...
  if (checking) return <main className="loading-page" role="status"><img src="/brand/taller-dimension-v2.png" alt="Taller Dimensión"/><span className="spinner"/> Abriendo tu espacio de trabajo…</main>;
